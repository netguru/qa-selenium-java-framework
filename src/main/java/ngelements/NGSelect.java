...
public class NGSelect extends NGHtmlElement {
    ...
    public void selectByIndex(int index) {
        ...
        log.info(String.format("Select by index: %s", Integer.toString(index)));
    }

    public void selectByValue(String value) {
        this.getSelect().selectByValue(value);
        log.info(String.format("Select by value: %s", value));
    }
    ...
    public void deselectByIndex(int index) {
        ...
        log.info(String.format("Deselected by index: %s", Integer.toString(index)));
    }

    public void deselectByVisibleText(String text) {
        this.getSelect().deselectByVisibleText(text);
        log.info(String.format("Deselected by text: %s", text));
    }
